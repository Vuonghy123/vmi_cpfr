...
export const headerHeight = scaleVertical(50);
...
export const window = {
    width: windowWidth,
    height: screenHeight - 2 * bar_height <= windowHeight ? windowHeight : screenHeight,
};
export const isLargePhone = windowHeight > 800
